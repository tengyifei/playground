...
def visualize_sharding(sharding: str,
  ...
  outer_table = rich.table.Table.grid()
  outer_table.add_column("Header Row", justify="center")
  outer_table.add_column("Main Table", justify="center")
  outer_table.add_row(
      rich.align.Align(
          '\n' + str(tensor_shape[0]), vertical="middle", align="right"), table)
  console.print(outer_table, end='\n\n')
  return outer_table
...
def visualize_tensor_sharding(t, **kwargs):
  ...
  return visualize_sharding(sharding, tuple(t.shape), **kwargs)
